...
# `#{pane_current_path}` probe from FM_FAKE_PANE_PATH, and carries the shared
# lease-capable fake treehouse, so this same stub set works for a crew/scout
# (non-secondmate) spawn's leased-worktree acquisition and confirmation.
